...
namespace GameOfLife
{
    public class RandomCellsDistribution
    {
        ...
        public void MakeRandomDistributionOfAliveCells(List<List<Cell>> listOfCells)
        {
        ...
        private void ChangeStatusInRandomCells(int numberOfCellsToMakeAlive, int lenghtOfBoardSide, List<List<Cell>> listOfCells)
        {
